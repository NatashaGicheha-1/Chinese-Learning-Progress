...
### Translate Pinyin sentences to Hanzi and English 
### Category: x, y and  z
1. Wǒ xǐhuan xuéxí Zhōngwén.
    * 我喜欢学习中文。
...
3. Yīfu zài zhuōzi shàng.
   * 衣服在桌子上。
      * The chair is on top of the table X
      * The clothes are on the table.✓

4) Yīshēng zài yīyuàn.
   * 医生在医院。
      * Doctor in hospital 
> Better version below.
...
> Better version below
       ...
       Thank you.(Thank you is two words)

6) Xuéshēng zuótiān xuéxí
   * 学生昨天学习。
      * The student studied yesterday.✓

7) Zhōngwǔ wǒ zài xuéxiào
   * 中午我在学校
      * My school is in China X
      * At noon I was in school.✓

8) Xiǎo háizi yǒu yīfu.
   * 小孩子有衣服。
      * Small child swim chair X
      * The small child has clothes.✓

9) Zhè shì wǒ de zhuōzi.
   * 这是我的桌子。
     * Where is my table? X (almost there)
     * This is my table. ✓

10) Wǒ zuò huǒchē qù xuéxiào.
school
   * 我坐火车去学校。
     * I go to school by train. ✓ (Not attempted)
...
- Yifu=clothes.
- Hanzi does not have spaces.
- Characters are written continuously, and native readers automatically recognize the word boundaries.
- To write emojis, press windows +. at the same time.
- When translating to English, think of the best way to say it instead.
- First time using chinese keyboard(Simplified, Mainland China).
- How to use the keyboard; type in pinyin, keyboard converts it to hanzi.

---------------------
## Active recall on category: s, t, w, x, y and  z
|Initial recall| After revision|
|---------------|--------------|
|- s=10/17||
|- x=5/16|13/16|
|- z=1.5/14|8/14|

- Need more practice on words in z category.
- Wrote down the words I remembered off-head in an exercise book pinyin-english, confirmed afterward with HSK1 Translated.md
...
# 1.Learn Mandarin Chinese by Melnyks Chinese
# Lesson 1:Basic Greetings in Mandarin Chinese
...
* Mostly I'll be writing on key parts
* *Possessive pronouns* - difference between 我 的 爸爸 和 我 爸爸
  * 我 的 爸爸 more formal.Wo de baba
  * 我 爸爸 more casual - Wo baba
