...
* Over time, I developed a more effective study strategy:
  1. Read the English meaning.
  2. Recall the Chinese translation from memory.
  3. Write it down.
  4. Check whether it was correct.
...
* Summary of each topic is provided in the folder 'Cultural Activities'.
* Each presentation compared aspects of Chinese culture with Western cultural practices.
...
Throughout my Mandarin journey, I have used:

- University course materials
- HSK vocabulary lists
- Duolingo
- Spotify podcasts
- Chinese Club activities
- Personal revision notes

Each resource contributed differently to my continuous learning journey.
